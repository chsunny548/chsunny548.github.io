  ...
  return (
    <div className="min-h-screen bg-blue-50 p-4 text-gray-800">
      <header className="text-center py-8">
        ...
        <p className="text-lg">MBBS, MD - General Medicine | 15+ years of experience</p>
      </header>
      <main className="grid gap-6 max-w-4xl mx-auto">
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p>Internal Medicine, Diabetes, Hypertension, Fever Management</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p>"Very attentive and professional. Solved my health issue quickly!"</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="text-center">
            ...
            <Button className="mr-2"><Mail className="w-4 h-4 mr-1" /> Email</Button>
            <Button><Phone className="w-4 h-4 mr-1" /> Call</Button>
          </CardContent>
        </Card>
      </main>
      <footer className="text-center mt-10 text-sm text-gray-600">
        &copy; 2025 Dr. Sunny Ch. All rights reserved.
      </footer>
    </div>
  );
}
